...
$LANG['EXTSERVICEID'] = 'Project ID from External Service';
$LANG['EXTSERVICETAXON'] = 'External Service Taxon Filter [optional]';
$LANG['LOC'] = 'Locality';
...
$LANG['DEFAULT_SORT'] = 'Default Sort Sequence';
$LANG['ACCESS'] = 'Access';
$LANG['PRIVATE'] = 'Private (anyone with link can view)';
$LANG['PRIVATE_STRICT'] = 'Strict Private (only editors can view)';
$LANG['PUBLIC'] = 'Public';
